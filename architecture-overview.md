# Architecture Overview: project-forge
...
- agent-planforge (Node.js CLI)
- scaffoldkit (Python CLI)
- GitHub REST API (repo creation, push)
- agent-engineering-playbook (referenced in prompts)
