...
| `API_TOKEN_HASH_SECRET` | Key for hashing API tokens (`pf_*`) at rest. Defaults to `NEXTAUTH_SECRET` when unset. Rotating it invalidates all previously issued API tokens. |
